...
d2 = net.addDocker('d2', ip='10.0.0.2', dimage="acksec/snort", environment={"CONTROLLER_IP": "controllerIP"})
d3 = net.addDocker('d3', ip='10.0.0.10', dimage="acksec/honeynet", environment={"CONTROLLER_IP": "controllerIP"})
